<%-- 
    ...
    Created on : May 15, 2022, 7:17:41 PM
    Author     : Pisano
--%>
        ...
        <div class="container">
            <div class="table-wrapper" style="margin-top: 80px">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <a href="home"><button type="button" class="btn btn-primary" style="margin-bottom: 70px">Back to home</button>
...
<!--                            <a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a>						-->
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <%--
                        lay du lieu san pham tu database
                        --%>
                            ...
                            <div class="form-group">
                                ...
                                <select name="category" class="form-select" aria-label="Default select example">
                                    <c:forEach items="${listCC}" var="o">
                                        <%--cho nguoi dung thay name nhung lay du lieu la id--%>
