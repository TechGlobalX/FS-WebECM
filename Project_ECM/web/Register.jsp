...
<body>  
<div class="signin-form" id="logreg-forms" action="signup" method="post" class="form-signup">
    <form class="form-signin" action="signup" method="post">
		...
		<div class="form-group">
            <input type="password" class="form-control input-lg" name="pass" id="inputPassword" placeholder="Password" required="required">
                ...
                <div class="form-group">
            <input name="repass" type="password" id="user-repeatpass" required autofocus="" class="form-control input-lg"  placeholder="ConfiredPassword" required="required">
        </div>  
                
                
                
        <div class="form-group">
            <button type="submit" class="btn btn-success btn-lg btn-block signin-btn">Sign Up</button>
        </div>
    </form>
